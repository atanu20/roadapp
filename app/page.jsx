...
function App() {
            ...
            {cabRoutes.map((route, index) => (
              <div key={index} className="route-card" style={{ animationDelay: `${index * 0.1}s` }}>
                <div className="route-card-image">
                  <img src="https://roadrunnercabs.in/wp-content/uploads/2025/01/bhopal-370x300-1.webp" alt={route.name} />
  ...
  22 2 13.93 2 4a1 1 0 011-1h3.5a1 
  1 0 011 1c0 1.27.2 2.47.57 
